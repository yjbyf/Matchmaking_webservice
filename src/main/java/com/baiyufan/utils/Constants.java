...
public class Constants {
	...
	public final static String USER_REST_WEBSERVICE_INSERT = SLASH + URL_PRIV
			+ SLASH + USER_REST_WEBSERVICE_PATH + SLASH + NEW;

	public final static String USER_REST_WEBSERVICE_MOD = SLASH + URL_PRIV
			+ SLASH + USER_REST_WEBSERVICE_PATH + SLASH + MOD;
	...
	public final static String PERSON_REST_WEBSERVICE_PATH_PRE_WTIH_SLASH = SLASH
			+ URL_PRIV + SLASH + PERSON_REST_WEBSERVICE_PATH;

	public final static String PERSON_REST_WEBSERVICE_INSERT = PERSON_REST_WEBSERVICE_PATH_PRE_WTIH_SLASH + SLASH + NEW;
	public final static String PERSON_REST_WEBSERVICE_MOD = PERSON_REST_WEBSERVICE_PATH_PRE_WTIH_SLASH + SLASH + MOD;
	...
	public final static String CONTRACT_QUERY_REST_WEBSERVICE_PATH = SLASH
			+ URL_PRIV + SLASH + CONTRACT_REST_WEBSERVICE_PATH ;

	public final static String CONTRACT_NEW_REST_WEBSERVICE_PATH = SLASH
			+ URL_PRIV + SLASH + CONTRACT_REST_WEBSERVICE_PATH + SLASH + NEW;
	
	public final static String CONTRACT_SAVE_REST_WEBSERVICE_PATH = SLASH
			+ URL_PRIV + SLASH + CONTRACT_REST_WEBSERVICE_PATH + SLASH + MOD;
	
	public final static String CONTRACT_DEL_REST_WEBSERVICE_PATH = SLASH
			+ URL_PRIV + SLASH + CONTRACT_REST_WEBSERVICE_PATH + SLASH + DEL;
	...
	public final static String MATCH_MOD_REST_WEBSERVICE_PATH = SLASH
			+ URL_PRIV + SLASH + MATCH_REST_WEBSERVICE_PATH + SLASH + MOD;

	public final static String MATCH_DEL_REST_WEBSERVICE_PATH = SLASH
			+ URL_PRIV + SLASH + MATCH_REST_WEBSERVICE_PATH + SLASH +DEL;
