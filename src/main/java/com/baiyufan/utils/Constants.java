...
public class Constants {
	...
	public final static String USER_REST_WEBSERVICE_COUNT = USER_REST_WEBSERVICE_PATH
			+ SLASH + "count";
	...
	public final static String CONTRACT_SAVE_REST_WEBSERVICE_PATH = CONTRACT_REST_WEBSERVICE_PATH
			+ "/save";
